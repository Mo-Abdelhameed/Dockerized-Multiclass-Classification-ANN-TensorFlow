...
from Classifier import load_predictor_model, Classifier, predict_with_model
...
def transform_req_data_and_make_predictions(
    ...
    predictions_arr = predict_with_model(model_resources.predictor_model, transformed_data)
